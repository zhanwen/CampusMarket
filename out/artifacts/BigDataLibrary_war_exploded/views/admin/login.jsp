...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/static/js/adminLogin.js"></script>
...
<div class="container">
        ...
        <form class="form-signin" action="/admin/manager">
            <h2 class="form-signin-heading">请登录</h2>
            <label for="inputStudentNo" class="sr-only">StudentNo</label>
            <input type="input" id="inputStudentNo" name="inputStudentNo" class="form-control" placeholder="用户名" required autofocus>
