    ...
    <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
        <div class="list-group">
            ...
            <div style="margin-left: 30px">
                <li class="active"><a style="color: red" href="${pageContext.request.getContextPath()}/school/researchPages">2017年</a></li>
                <li class="third"><a  href="${pageContext.request.getContextPath()}/school/researchPages/2016">2016年</a></li>
                <li class="third"><a  href="${pageContext.request.getContextPath()}/school/researchPages/2015">2015年</a></li>
                <li class="third"><a  href="${pageContext.request.getContextPath()}/school/researchPages/2014">2014年</a></li>
                <li class="third"><a  href="${pageContext.request.getContextPath()}/school/researchPages/2013">2013年</a></li>
            </div>
