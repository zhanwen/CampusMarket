...
<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
    <div class="list-group">
        ...
        <div style="margin-left: 30px">
            ...
            <li class="third"><a <c:if test="${pages == '2016'}">style="color: red" </c:if> href="${pageContext.request.getContextPath()}/school/academicPages/2016">2016年</a></li>
            <li class="third"><a <c:if test="${pages == '2015'}">style="color: red" </c:if> href="${pageContext.request.getContextPath()}/school/academicPages/2015">2015年</a></li>
            <li class="third"><a <c:if test="${pages == '2014'}">style="color: red" </c:if> href="${pageContext.request.getContextPath()}/school/academicPages/2014">2014年</a></li>
            <li class="third"><a <c:if test="${pages == '2013'}">style="color: red" </c:if> href="${pageContext.request.getContextPath()}/school/academicPages/2013">2013年</a></li>
        </div>
    </div>
</div>
